...
number: 28
name: Viber бутонът с номер, който ИМА Viber акаунт (разделяне на причините за G-02-5)
expected: |
  На СЪЩИЯ Android телефон отвори наново https://torin.bg/new/index.html
  и натисни «Пишете във Viber».

  Деплойнато е преди малко: бутонът вече сочи към viber://chat?number=%2B359888216639
  вместо към стационарния номер. Схемата е абсолютно същата — сменен е само номерът.

  Това разделя двете причини:
    - ОТВАРЯ разговор  -> схемата viber://chat е правилна, грешен беше само номерът
    - СЪЩАТА грешка    -> схемата също е грешна и трябва да се смени

  Ако кешът ти върне старата страница, презареди — план 02-08 сложи ?v= стамп,
  така че новият site-config се вижда веднага.
